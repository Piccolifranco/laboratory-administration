...
const styles = StyleSheet.create({
  page: {
    padding: 30,
    // Reserve enough bottom space for the fixed footer (microscope + signature)
    // so flowing content never collides with them on a full page.
    paddingBottom: 120,
  },
  text: {
    fontSize: 12,
...
const PapDiagnosisComponent = ({
  ...
  <Page wrap style={styles.page}>
    ...
    <Text style={styles.content}>Pap clase: {visita[visita.type]?.class}</Text>
...
const CepilladoDiagnosisComponent = ({
  ...
  <Page wrap style={styles.page}>
    ...
    <Text style={styles.content}>Fondo: {visita.cepilladoDiagnosis.fondo}</Text>

    <Text style={[styles.title, styles.bold]}>DIAGNOSTICO DESCRIPTIVO</Text>
    <Text style={styles.content}>{visita.cepilladoDiagnosis.description}</Text>

    <Text style={[styles.title, styles.bold]}>DIAGNOSTICO</Text>
    <Text style={styles.content}>{visita.cepilladoDiagnosis.title}</Text>
    <Text style={styles.content}>Nota: {visita.cepilladoDiagnosis.notes}</Text>
