      ...
      <DialogHeadless className="relative z-10" onClose={removeQueryParams}>
        ...
        <div className="fixed inset-0 z-10 w-screen ">
          <div className="flex min-h-full items-end justify-center md:p-4 text-center sm:items-center p-0">
            ...
            >
              <DialogPanel
                className={`relative transform overflow-hidden rounded-lg bg-white text-left transition-all flex w-[100%] ${
                  width ? width : "md:w-[90%]"
                } flex-col`}
              >
                <div className="bg-white flex-1 max-h-[100vh] md:max-h-[90vh] px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
